		...
		<div class="bgofrow">
			...
			<div class="container">
				...
				<div class="sectionr ones">
					...
					<div class="col-md-6 col-sm-12 col-lg-6">
						<h2>VERO 1’s goal is to provide the ultimate in convenience from home</h2>
